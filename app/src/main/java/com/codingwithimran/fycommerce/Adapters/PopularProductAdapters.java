...
public class PopularProductAdapters extends RecyclerView.Adapter<PopularProductAdapters.productViewHolder>{

    Context context;
    ArrayList<PopularProductModal> list;

    public PopularProductAdapters(Context context, ArrayList<PopularProductModal> list) {
    ...
    @NonNull
    @Override
    public PopularProductAdapters.productViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_item, parent, false);
        return new PopularProductAdapters.productViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull productViewHolder holder, @SuppressLint("RecyclerView") int position) {
        PopularProductModal productModal = list.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("popularProductDetail",  list.get(position));
