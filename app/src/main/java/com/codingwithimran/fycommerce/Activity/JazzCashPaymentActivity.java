...
public class JazzCashPaymentActivity extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID      = "MC54675";
    private final String Jazz_Password        = "v072v76220";
    private final String Jazz_IntegritySalt   = "1f00dvu3u9";
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(JazzCashPaymentActivity.this, PaymentActivity.class);
